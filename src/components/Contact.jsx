...
const Contact = () => {
    ...
    const [state, handleSubmit] = useForm("xldngdoq");
        ...
        <section className=" sm:px-8 pt-[80px]" id="contact">
            ...
            <div className="grid md:grid-cols-2 mt-4 md:mt-10 py-12 gap-4 relative">
                ...
                >
                    ...
                    <div className="flex flex-row gap-5 mt-6">
                        <a
                            href="https://github.com/Ambika03p"
                        ...
                        <a
                            href="https://www.linkedin.com/in/ambika-03p/"
                            className="relative group hover:-translate-y-[2px] transition-all duration-500 ease-in-out "
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                        ...
                        <a
                            href="https://twitter.com/Ambika_dhimaan"
                            className="relative group hover:-translate-y-[2px] transition-all duration-500 ease-in-out "
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                    ...
                    {show ? (
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col">
                            ...
                            <button
                                ...
                                className="rounded-full mr-4 bg-transparent border-white border-2 text-white text-center hover:bg-darkHover font-medium py-2.5 px-5 w-full hover:scale-[0.98] transition-all duration-500 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
                            >
            ...
            <footer className="flex items-center p-6 text-center">
                <span className="w-full text-textPara">
                    All Rights Reserved © {new Date().getFullYear()} - Ambika
                </span>
            </footer>
        </section>
    );
