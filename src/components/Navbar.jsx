    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-30 bg-bgDark">
            ...
            >
                ...
                >
                    {/* for mobile view */}
                    <span className="sm:hidden">@Ambika</span>
                    {/* for web view */}
                    <span className="hidden sm:block">@Ambika</span>
                </ScrollLink>
                        ...
                        >
                            <div className="flex flex-col md:hidden bg-bgDark relative p-10">
                                ...
                                <div className="flex gap-4 p-6 border-b-white border-b-2 text-[22px]">
                                    <a
                                        href="https://www.linkedin.com/in/Ambika-dhiman/"
                                        target="_blank"
                                    ...
                                    <a
                                        href="https://github.com/Ambika-dhiman"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <BsGithub />
                                    </a>
                                    <a href="mailto:Ambikadhiman88@gmail.com">
                                        <HiMailOpen />
                                    </a>
                                </div>
